...
export async function getParameterResults(
  ...
  const sql = `
    SELECT r.id, r.parameter_id, p.name, p.description, p.scope_type as scope_type, p.max_value as max_value, r.value, r.numeric_value, r.option_id, r.feedback, r.version, r.scored_at
